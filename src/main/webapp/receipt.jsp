        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:if test="${roles=='frontdesksonography' or roles=='frontdeskxray'}">
                 <c:if test="${roles=='frontdesksonography'}">
                 	<c:set var="role" value="Ultrasound"/> 
                 </c:if>
                  <c:if test="${roles=='frontdeskxray'}">
                 	<c:set var="role" value="X-Ray"/> 
                 </c:if>
               ...
               <c:if test="${fn:contains(testcat,role)}"> 
                <tr>
                  ...
                  <td>
                    <div class="">
                      <a onclick="editreceipt('${receiptList.receipt.id}')" class="btn btn-social-icon btn-success"><i class="fa fa-pencil"></i></a>
                    </div>
                  </td>
