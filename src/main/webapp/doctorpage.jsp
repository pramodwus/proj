        ...
        <li class="active treeview menu-open">
          <a href="#">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="doctorpage"><i class="fa fa-circle-o"></i>Doctor</a></li>
    ...
    <section class="content-header">         
        <div class="box-header ui-sortable-handle" style="cursor: move;">  
            ...
            <div class="pull-right box-tools">
                <button  class="btn bg-olive btn-flat" style="margin-right: 10px;"><a href="adddoctorpage" style="text-decoration:none;color:#fff;">Add New Doctor</a></button>
        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach items="${doctor}" var="docotrList" varStatus="loop">
                <tr>
                    <td>${docotrList.id}</td>
                    <td>${docotrList.regno}</td>
                    <td style="text-transform: capitalize">${docotrList.sirName} ${docotrList.firstName} ${docotrList.middleName} ${docotrList.lastName}</td>
                    <td style="text-transform: capitalize">${docotrList.gender}</td>
                    <td>${docotrList.email}</td>
                    <c:if test="${docotrList.contactNumber!='(+91)'}">
                   <td>${docotrList.contactNumber}</td>
                   </c:if>
                   <c:if test="${docotrList.contactNumber=='(+91)'}">
                   <td></td>
                   </c:if>
                   <td style="text-transform: capitalize">${docotrList.qualification}</td>
                    <td class="col-sm-1" style="text-align:center;width: 2%;">
                      <div class="">
                      <button onclick="editdoctor('${docotrList.id}')" class="btn btn-success"><i class="fa fa-pencil"></i></button> 
                        
                      </div>
                    </td>
                     <td class="col-sm-1" style="text-align:center;width: 2%;"> 
                     <div class="">
                     <button type="button" id="button-remove" onclick="deleteDoctor(${docotrList.id})" class="btn btn-social-icon btn-success"><i class="fa fa-trash"></i></button>
                    </div>
                    </td>
                </tr>
                </c:forEach>
...
function editdoctor(id){
 ...
 function deleteDoctor(id){
	 var data=confirm("Do you really want to delete the Doctor Data");
	 if(data){
		  $.ajax({
	         url: 'deleteDoctor',
	         type: 'post',
