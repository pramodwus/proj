          ...
          <div class="row">
              <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="addoctor" method="post">
                      <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control disabledboxes" id="" placeholder="Last Name" name="lastName" >
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="regno" class="form-control disabledboxes" id="" placeholder="Registraion No." > 
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-4">
                          <input type="email" name="email" class="form-control disabledboxes" id="" placeholder="Enter Email" > 
                        </div>
                      </div>
 					 <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Age</label>
                        <div class="col-sm-1"  style="width:13%;">
                          <input type="number" class="form-control disabledboxes" id="" placeholder="Age" name="age" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="radio">
                            <label>
                              <input type="radio" name="gender" value="male" id="optionsRadios1"  >
                              Male
                            </label>
                            <label>
                              <input type="radio" name="gender" value="female" id="optionsRadios1">
                              Female
                            </label>
                            <label>
                              <input type="radio" name="gender" value="other" id="optionsRadios1">
                              Others
                            </label>
                          </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <textarea name="address" class="form-control disabledboxes" id="" placeholder="Enter Adress" rows="2" ></textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                          <input type="text" name="city" class="form-control disabledboxes" id="" placeholder="Enter City" >
                        </div>
                      </div>
                       <div class="form-group">
                        <label for="" class="col-sm-2 control-label">PinCode</label>
                          <div class="col-sm-4">
                          <input type="tel" class="form-control disabledboxes" id="pincode"  placeholder="Enter PinCode" name="pincode" pattern="^\d{6}$" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-3" style="width:22%;">
                           <input type="tel" class="form-control disabledboxes" id="phone"  placeholder="Enter Contact Num." name="contactNumber" pattern="^\d{10}$" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Qualification</label>
                        <div class="col-sm-4">
                          <input type="text" name="qualification" class="form-control disabledboxes" id="" placeholder="Enter Qualification" >
                        </div>
                      </div>
