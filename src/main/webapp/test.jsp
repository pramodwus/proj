    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="test"><i class="fa fa-circle-o"></i>Test</a></li>
        ...
        <div class="box-header ui-sortable-handle" style="cursor: move;">  
            ...
            <!-- tools box -->
             <div class="pull-right box-tools">
                <button type="button" class="btn bg-olive btn-flat"><a href="add_new_test.html" style="text-decoration:none;color:#fff;">Add New Test</a></button>
            </div> 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <div class="">
                          <a href="edit_test.html" class="btn btn-social-icon btn-success"><i class="fa fa-pencil"></i></a>
                        </div>
                  </td>
                  <!-- <td>
                    <div class="">
                      <a class="btn btn-social-icon btn-success"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-social-icon btn-success"><i class="fa fa-close"></i></a>
                      <a class="btn btn-social-icon btn-success"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td> -->
