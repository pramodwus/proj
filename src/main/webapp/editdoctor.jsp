                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="editdoctor" method="post">
                      ...
                      <input type="hidden" name ="id" value="${doctor.id}">
                        ...
                        <div class="col-sm-1">
                            ...
                            <select name="sirName" class="form-control select2" style="width: 57px;padding: 6px;" >
                                <option selected="selected" >${doctor.sirName}</option>
                              
                                
                              </select>
                          </div>
                        <div class="col-sm-3">
                          <input type="text" class="form-control disabledboxes" id="" placeholder="First Name" value="${doctor.firstName}" name="firstName" required>
                        </div>
                        <div class="col-sm-2">
                          <input type="text" class="form-control disabledboxes" id="" placeholder="Middle Name"  value="${doctor.middleName}" name="middleName">
                        </div>
                        <div class="col-sm-3">
                          <input type="text" class="form-control disabledboxes" id="" placeholder="Last Name"   value="${doctor.lastName}" name="lastName" >
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="regno" class="form-control disabledboxes" id="" placeholder="Registraion No." value="${doctor.regno}"> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-4">
                          <input type="email" name="email" class="form-control disabledboxes" id="" value="${doctor.email}" placeholder="Enter Email" > 
                        </div>
                      </div>
 					 <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Age</label>
                        <div class="col-sm-1"  style="width:13%;">
                          <input type="number" class="form-control disabledboxes" id="" placeholder="Age" name="age" value="${doctor.age}" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="radio">
                            <label>
                              <input type="radio" name="gender" value="male" id="optionsRadios1" <c:if test="${doctor.gender == 'male'}">  checked </c:if> >
                              Male
                            </label>
                            <label>
                              <input type="radio" name="gender" value="female" id="optionsRadios1" <c:if test="${doctor.gender == 'female'}">  checked   </c:if>>
                              Female
                            </label>
                            <label>
                              <input type="radio" name="gender" value="other" id="optionsRadios1" <c:if test="${doctor.gender == 'other'}">  checked   </c:if>>
                              Others
                            </label>
                          </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <textarea name="address"  class="form-control disabledboxes" id="" placeholder="Enter Adress" rows="2" >${doctor.address}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                          <input type="text" name="city" value="${doctor.city}" class="form-control disabledboxes" id="" placeholder="Enter City" >
                        </div>
                      </div>
                       <div class="form-group">
                        <label for="" class="col-sm-2 control-label">PinCode</label>
                          <div class="col-sm-4">
                          <input type="tel" class="form-control disabledboxes" id="pincode" value="${doctor.pincode}"  placeholder="Enter PinCode" name="pincode" pattern="^\d{6}$" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-3" style="width:22%;">
                           <input type="tel" class="form-control disabledboxes" id="phone" value="${doctor.contactNumber}"  placeholder="Enter Contact Number" name="contactNumber" pattern="^\d{10}$" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Qualification</label>
                        <div class="col-sm-4">
                          <input type="text" name="qualification" class="form-control disabledboxes" value="${doctor.qualification}" id="" placeholder="Enter Qualification" >
                        </div>
                      </div>
                      ...
                      <div class="box-footer">
                        <button type="submit" class="btn btn-success" id="button1">Save Doctor details</button>
                      </div>
                      <!-- /.box-footer -->
                    </form>
                  </div>
