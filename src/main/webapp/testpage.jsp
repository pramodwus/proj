    ...
    <section class="content-header">         
        <div class="box-header ui-sortable-handle" style="cursor: move;">  
            ...
            <div class="pull-right box-tools">
                <button  class="btn bg-olive btn-flat" style="margin-right: 10px;"><a href="addtestpage" style="text-decoration:none;color:#fff;">Add New Test</a></button>
        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <c:forEach items="${test}" var="testList" varStatus="loop">
                <tr>
                    <td>${loop.index+1}</td>
                    <td>${testList.testCategory}</td>
                    <td>${testList.testName}</td>
                    <td>${testList.rate}</td>
                   <td>${testList.doctorpercentage}</td>
                  <td>${testList.testTemplate}</td>
                    <td class="col-sm-1" style="text-align:center;width: 2%;">
                      <div class="">
                      <button onclick="edittest('${testList.id}')" class="btn btn-success"><i class="fa fa-pencil"></i></button> 
                    ...
                    <td class="col-sm-1" style="text-align:center;width: 2%;"> 
                     <div class="">
                     <button type="button" id="button-remove" onclick="deletetest(${testList.id})" class="btn btn-social-icon btn-success"><i class="fa fa-trash"></i></button>
                    </div>
                    </td>
                </tr>
                </c:forEach>
...
function edittest(id){
	var form = $('<form action="edittestpage" method="post">' +
 ...
 function deletetest(id){
	 var data=confirm("Do you really want to delete the Test");
	 if(data){
		  $.ajax({
	         url: 'deleteTest',
	         type: 'post',
