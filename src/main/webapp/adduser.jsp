                    ...
                    <div class="box-body">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="email" name="emailId" class="form-control disabledboxes" id="" placeholder="Enter Email" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Age</label>
                        <div class="col-sm-1"  style="width:13%;">
                          <input type="number" class="form-control disabledboxes" id="" placeholder="Age" name="age" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="radio">
                            <label>
                              <input type="radio" name="gender" value="male" id="optionsRadios1"  checked >
                              Male
                            </label>
                            <label>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-3" style="width:22%;">
                           <input type="tel"  title="Please fill 10 digit mobile number" class="form-control disabledboxes" id="phone" value="" placeholder="Enter Contact Num." name="contactNumber" pattern="^\d{10}$" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="password" name="password" class="form-control disabledboxes" id="" placeholder="Enter Password" required>
                        </div>
                      </div>
                                      ...
                                      <div class="form-group">
											...
											<div class="col-sm-4">
												<select id="role1" name ="role" class="form-control disabledboxes" required>
													...
													<option value="frontdesklabassistant">Front Desk + Lab Assistant</option>
													<option value="frontdesksonography">Front Desk-Sonography</option>
													<option value="frontdeskxray">Front Desk-X-Ray</option>
												</select>
											</div>
										</div>
                         </div>					
