                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="saveUser" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="firstname" class="form-control disabledboxes" id="" placeholder="First Name" required>
                        </div>
                        <div class="col-sm-3">
                          <input type="text"  name="lastname" class="form-control disabledboxes" id="" placeholder="Last Name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-4">
                          <input type="email" name="emailId" class="form-control disabledboxes" id="" placeholder="Enter EmailId" required>
                        </div>
                      </div>
 						<div class="form-group">
