                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="addoctor" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="name" class="form-control disabledboxes" id="" placeholder="First Name" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="email" name="email" class="form-control disabledboxes" id="" placeholder="Enter EmailId" required> 
                        </div>
                      </div>
 						<div class="form-group">
                        <label for="" class="col-sm-2 control-label">Age</label>
                        <div class="col-sm-4">
                          <input type="text" name="age" class="form-control disabledboxes" id="" placeholder="Enter Age" required>
                        </div>
                      </div>
                     <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="address" class="form-control disabledboxes" id="" placeholder="Enter Adress" required>
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="city" class="form-control disabledboxes" id="" placeholder="Enter City" required>
                        </div>
                        <div class="col-sm-2">
                          <input type="text" name="pincode" class="form-control disabledboxes" id="" placeholder="Enter Pincode" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Contact number</label>
                        <div class="col-sm-4">
                          <input type="text" name="contactNumber" class="form-control disabledboxes" id="" placeholder="Enter Contact number" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Qualification</label>
                        <div class="col-sm-4">
                          <input type="text" name="qualification" class="form-control disabledboxes" id="" placeholder="Enter Qualification" required>
                        </div>
                      </div>
