                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="editUser" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="firstName" class="form-control disabledboxes" id="" placeholder="First Name" value="${user.firstName}" required>
                        </div>
                        <div class="col-sm-3">
                          <input type="text"  name="lastName" class="form-control disabledboxes" id="" placeholder="Last Name" value="${user.lastName}" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-4">
                          <input type="email" name="email" class="form-control disabledboxes" id="" placeholder="Enter EmailId" value="${user.email}" required>
                        </div>
                      </div>
 						<div class="form-group">
                        <label for="" class="col-sm-2 control-label">Password</label>
                        <div class="col-sm-4">
                          <input type="text" name="password" class="form-control disabledboxes" id="" placeholder="Enter Password" required>
                        </div>
                      </div>
                     ...
                     <div class="form-group">
											...
											<div class="col-sm-4">
												<select id="role1" name ="roles" class="form-control disabledboxes" required>
