            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/front_end_desk/login.html" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <aside class="main-sidebar">
          ...
          <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li><a href="index.html"><i class="fa fa-circle-o"></i>Patient</a></li>
              <li><a href="receipt.html"><i class="fa fa-circle-o"></i>Reciept</a></li>
                ...
                <a href="#">
                  ...
                  <li class="active treeview menu-open">
                      <a href="#">
                        ...
                        <ul class="treeview-menu"> 
                            <li class="active"><a href="new_report_template.html"><i class="fa fa-circle-o"></i>Maintenance</a></li>
                            <!-- <li><a href="summary_doctor.html"><i class="fa fa-circle-o"></i>Summary For Doctors</a></li>
                            <li><a href="summary_hospital.html"><i class="fa fa-circle-o"></i>Summary For Hospital</a></li> -->
                            <!-- <li><a href="#"><i class="fa fa-circle-o"></i>Admin</a></li> -->
                        </ul>
                        </li>
                        <li><a href="lab_assistant.html"><i class="fa fa-circle-o"></i>Lab Assistant</a></li>
                </section>
              <!-- </li>
            </ul>        
            ...
            <form class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Patient Name- ${patient.firstName}</label>
                        <div class="col-sm-3">
                         <%-- <label for="" class="col-sm-3 control-label">${patient.firstName}</label> --%>
                          <!-- <input type="text" class="form-control disabledboxes" id="recieptNumber" placeholder="123456789" disabled=""> -->
                        </div>
                        <label for="" class="col-sm-3 control-label" style="">Age/Gender- ${patient.age}/ ${patient.gender}</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                            ...
                            <label for="" class="col-sm-3 control-label" style="">Date- ${date}</label>
                            <div class="col-sm-3">
                              <!-- <input type="text" class="form-control disabledboxes" id="recieptDate" placeholder="15/04/2019" disabled=""> -->
                            </div>                       
                          </div>
