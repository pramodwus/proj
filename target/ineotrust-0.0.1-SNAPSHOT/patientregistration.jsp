                    ...
                    <form class="form-horizontal" method="post" action="/savepatient">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" class="form-control disabledboxes" id=""  placeholder="Enter Contact Number" name="contactNumber" pattern="^\d{10}$" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" class="form-control disabledboxes" id=""  placeholder="Enter PinCode" name="pincode" pattern="^\d{6}$" required>
                         </div>
                      </div>
                   <!--    <div class="form-group">
