                  ...
                  <div class="box box-info">
                    ...
                    <!-- form start -->
                     <c:if test="${testmsg1=='sucess'}">
                      ...
                      <center> <span style="color:red">test Data does not  Exist!</span></center>
                      </c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <textarea  name="testTemplate" class="form-control disabledboxes" id="" placeholder="Enter Test Template"> ${test.testTemplate} </textarea>
                        </div>
                      </div>
