                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" action="/updatepatient">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            ...
                            <select name="sirName" class="form-control select2" style="width: 57px;padding: 6px;">
                                <option selected="selected">${patient.sirName}</option>
                                 <option>Mr.</option>
                                <option>Mrs.</option>
                                <option>Ms.</option>
                              </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control disabledboxes" id="" value="${patient.age}" name="age">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" class="form-control disabledboxes" id="" value="${patient.contactNumber}" name="contactNumber" pattern="^\d{10}$" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" class="form-control disabledboxes" id=""   name="pincode" value="${patient.pincode}" pattern="^\d{6}$" required>
                         </div>
                      </div>
