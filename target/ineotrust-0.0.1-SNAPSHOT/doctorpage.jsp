            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <c:forEach items="${doctor}" var="docotrList" varStatus="loop">
                <tr>
                    <td>${docotrList.id}</td>
                    <td>${docotrList.name}</td>
                    <td>${docotrList.gender}</td>
                    <td>${docotrList.age}</td>
                   <td>${docotrList.email}</td>
                   <td>${docotrList.address}</td>
                   <td>${docotrList.city}</td>
                   <td>${docotrList.pincode}</td>
                   <td>${docotrList.contactNumber}</td>
                   <td>${docotrList.qualification}</td>
                    <td>
                      <div class="">
                      <button onclick="editdoctor('${docotrList.email}')" class="btn btn-success"><i class="fa fa-pencil"></i></button> 
