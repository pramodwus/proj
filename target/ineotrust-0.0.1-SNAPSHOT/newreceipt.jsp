                    ...
                    <th class="col-sm-2" style="text-align:center">Referred Doctor</th>
                      ...
                      <label for="" class="col-sm-2 control-label">Total Test Amount</label>
                       ...
                       <!--  <button type="button" id="save" class="btn btn-success">Save </button>
                        ...
                        <button type="button" id="save" class="btn btn-success" <c:if test="${patient.receipt.receiptSave == 1}"> disabled </c:if>>Save </button>
<button type="button" id="print" class="btn btn-success" <c:if test="${patient.receipt.receiptSave == 0}"> disabled </c:if> <c:if test="${patient.receipt.receiptStatus == 1}"> disabled </c:if>>
<c:if test="${patient.receipt.receiptStatus ==0}"> Print Receipt </c:if> <c:if test="${patient.receipt.receiptStatus == 1}"> Receipt Generated </c:if></button>
	...
	$.ajax({
	 ...
	 function getTestName(){
		 $.ajax({
	            ...
	            success: function(response){
	            	$('#specificTest').empty().append('<option>Select test</option>');
