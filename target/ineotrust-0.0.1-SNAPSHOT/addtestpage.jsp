                  ...
                  <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="addTest" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <!-- <select name="testCategory" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                  ...
                                  <option   value="Sonography without film">Sonography without film</option>
                                  <option  value="X-ray">X-ray</option>
                                  <option  value="Echo3">Echo3</option>
                                </select> -->
                                <input type="text" name="testCategory" class="form-control disabledboxes" id="" placeholder="Enter Test Category">
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="testName" class="form-control disabledboxes" id="" placeholder="Enter Test Name">
                        </div>
                      </div>
 						<div class="form-group">
                        <label for="" class="col-sm-2 control-label">Rate</label>
                        <div class="col-sm-4">
                          <input type="text" name="rate" class="form-control disabledboxes" id="" placeholder="Enter Rate">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Doctor Percentage</label>
                        <div class="col-sm-4">
                          <input type="text" name="doctorpercentage" class="form-control disabledboxes" id="" placeholder="Enter Doctor Percentage">
                        </div>
                      </div>
                     <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Test Template</label>
                        <div class="col-sm-4">
                          <textarea  name="testTemplate" class="form-control disabledboxes" id="" placeholder="Enter Test Template"></textarea>
                        </div>
                      </div>
